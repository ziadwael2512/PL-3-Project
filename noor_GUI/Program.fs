...
let createDeleteContactForm () =
    ...
    let infoLabel = new Label(Text = "Contact Info:", Top = 60, Left = 30, Font = new Font("Arial", 10.0f, FontStyle.Bold))
    let contactInfoLabel = new Label(Top = 100, Left = 30, Width = 400, Height = 150, BorderStyle = BorderStyle.FixedSingle, TextAlign = ContentAlignment.MiddleCenter, Font = new Font("Arial", 10.0f))

    let deleteButton = new Button(Text = "Delete Contact", Top = 270, Left = 150, Width = 200, BackColor = Color.LightCoral, Font = new Font("Arial", 10.0f, FontStyle.Bold))
    let resultLabel = new Label(Top = 330, Left = 30, Width = 400, Height = 100, BorderStyle = BorderStyle.FixedSingle, TextAlign = ContentAlignment.MiddleCenter, Font = new Font("Arial", 12.0f, FontStyle.Bold))

    // Add controls
    deleteForm.Controls.AddRange [| idLabel; idTextBox; infoLabel; contactInfoLabel; deleteButton; resultLabel |]
    ...
    deleteButton.Click.Add(fun _ -> 
        ...
        // Simulate fetching contact info and deletion
        contactInfoLabel.Text <- "Name: John Doe\nPhone: 123456789\nEmail: johndoe@example.com"
